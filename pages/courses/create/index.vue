                        ...
                        >
                          <div class="px-4 md:px-5 lg:px-6 py-4">
                            ...
                            <div class="form-group">
                              ...
                              <div v-if="!videoUploading" class="relative h-full">
                                <input
                                  ref="input"
                                  type="file"
                                  name="image"
                  ...
                  <div class="px-4 md:px-5 lg:px-6 py-4">
                    ...
                    <div class="border-b border-gray-300 pb-5 mb-4">
                      ...
                      <div class="grid grid-cols-12">
                        ...
                        <div class="col-span-5 text-right">
                          <input-toggle-switch v-model="graduation.allAssignment"/>
                        </div>
                      </div>
                    ...
                    <div class="border-b border-gray-300 pb-5 mb-4">
                      ...
                      <div class="grid grid-cols-12">
                        ...
                        <div class="col-span-5 lg:col-span-4 text-right">
                          <input-toggle-switch v-model="graduation.generateCertificate"/>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="px-4 md:px-5 lg:px-6 py-4">
                    ...
                    <div class="form-group mb-5">
                      ...
                      <div class="flex flex-row justify-between my-4">
                        ...
                        <div class="col-span-5 text-right">
                          <input-toggle-switch v-model="promo.runPricePromotion" />
                        </div>
                      </div>
                      <div class="flex flex-row justify-between my-4">
                        <div
      ...
      try {
        if (this.course) {
          const { data, message } = await this.$axios.$put(
            `https://streaming.staging.klasroom.com/v1/courses/${this.course.id}?publish_now=${true}`,
            {
              title: this.course.title,
              subtitle: this.course.subtitle,
              introductory_text: this.course.introductory_text,
              introductory_video: this.course.introductory_video,
              tags: this.course.tags,
              category_ids: this.course.categoryId,
              tutor_email: this.course.tutor_email,
              image: this.course.image,
              course_benefits: this.course.course_benefits
            },
            {
        ...
        case 2:
          ...
          try {
            ...
            if (this.graduationId) {
              const { data: graduationData } = await this.$axios.$put(
